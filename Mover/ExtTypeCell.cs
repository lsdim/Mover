...
namespace Mover
{
  //  public class ComboBoxCell : DataGridViewColumn
   public class CalendarColumn : DataGridViewColumn
    ...
    public class ComboBoxColumn : DataGridViewColumn
    {
        ...
        public ComboBoxColumn(object dataSource)
            : base(new ComboBoxCell(dataSource))
        {
        }
    ...
    public class ComboBoxCell : DataGridViewTextBoxCell
    {
        ...
        private object DS; //DataSource

        public ComboBoxCell(object dataSource)
            : base()
        {
            DS = dataSource;
        }
    ...
    class ComboBoxEditingControl : ComboBox, IDataGridViewEditingControl
    {
       ...
       /* public ComboBoxEditingControl(object dataSource )
        {
